...
roomie_msgs__msg__TrackingEvent__init(roomie_msgs__msg__TrackingEvent * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->timestamp)) {
    roomie_msgs__msg__TrackingEvent__fini(msg);
    return false;
  }
  return true;
}
...
roomie_msgs__msg__TrackingEvent__are_equal(const roomie_msgs__msg__TrackingEvent * lhs, const roomie_msgs__msg__TrackingEvent * rhs)
{
  ...
  // tracking_event_id
  if (lhs->tracking_event_id != rhs->tracking_event_id) {
    return false;
  }
  // task_id
  ...
  roomie_msgs__msg__TrackingEvent * output)
{
  ...
  // tracking_event_id
  output->tracking_event_id = input->tracking_event_id;
  // task_id
...
roomie_msgs__msg__TrackingEvent__create(void)
{
  ...
  roomie_msgs__msg__TrackingEvent * msg = (roomie_msgs__msg__TrackingEvent *)allocator.allocate(sizeof(roomie_msgs__msg__TrackingEvent), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(roomie_msgs__msg__TrackingEvent));
  bool success = roomie_msgs__msg__TrackingEvent__init(msg);
  if (!success) {
...
roomie_msgs__msg__TrackingEvent__Sequence__init(roomie_msgs__msg__TrackingEvent__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  roomie_msgs__msg__TrackingEvent * data = NULL;

  if (size) {
    data = (roomie_msgs__msg__TrackingEvent *)allocator.zero_allocate(size, sizeof(roomie_msgs__msg__TrackingEvent), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = roomie_msgs__msg__TrackingEvent__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        roomie_msgs__msg__TrackingEvent__fini(&data[i - 1]);
      }
...
roomie_msgs__msg__TrackingEvent__Sequence__fini(roomie_msgs__msg__TrackingEvent__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      roomie_msgs__msg__TrackingEvent__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  roomie_msgs__msg__TrackingEvent__Sequence * array = (roomie_msgs__msg__TrackingEvent__Sequence *)allocator.allocate(sizeof(roomie_msgs__msg__TrackingEvent__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = roomie_msgs__msg__TrackingEvent__Sequence__init(array, size);
  if (!success) {
...
roomie_msgs__msg__TrackingEvent__Sequence__destroy(roomie_msgs__msg__TrackingEvent__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    roomie_msgs__msg__TrackingEvent__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
roomie_msgs__msg__TrackingEvent__Sequence__are_equal(const roomie_msgs__msg__TrackingEvent__Sequence * lhs, const roomie_msgs__msg__TrackingEvent__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!roomie_msgs__msg__TrackingEvent__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  roomie_msgs__msg__TrackingEvent__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(roomie_msgs__msg__TrackingEvent);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    roomie_msgs__msg__TrackingEvent * data =
      (roomie_msgs__msg__TrackingEvent *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!roomie_msgs__msg__TrackingEvent__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          roomie_msgs__msg__TrackingEvent__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!roomie_msgs__msg__TrackingEvent__copy(
