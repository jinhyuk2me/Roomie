...
// IWYU pragma: private, include "roomie_msgs/srv/control_lock.h"


#ifndef ROOMIE_MSGS__SRV__DETAIL__CONTROL_LOCK__FUNCTIONS_H_
#define ROOMIE_MSGS__SRV__DETAIL__CONTROL_LOCK__FUNCTIONS_H_
...
/// Initialize srv/ControlLock message.
/**
 ...
 * )) before or use
 * roomie_msgs__srv__ControlLock_Request__create()
...
/// Finalize srv/ControlLock message.
/**
...
/// Create srv/ControlLock message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * roomie_msgs__srv__ControlLock_Request__init().
...
/// Destroy srv/ControlLock message.
/**
 * It calls
 * roomie_msgs__srv__ControlLock_Request__fini()
...
/// Check for srv/ControlLock message equality.
/**
...
/// Copy a srv/ControlLock message.
/**
...
/// Initialize array of srv/ControlLock messages.
/**
...
/// Finalize array of srv/ControlLock messages.
/**
 * It calls
 * roomie_msgs__srv__ControlLock_Request__fini()
...
/// Create array of srv/ControlLock messages.
/**
...
/// Destroy array of srv/ControlLock messages.
/**
 * It calls
 * roomie_msgs__srv__ControlLock_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ControlLock message array equality.
/**
...
/// Copy an array of srv/ControlLock messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * roomie_msgs__srv__ControlLock_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_roomie_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * roomie_msgs__srv__ControlLock_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_roomie_msgs
...
/**
 * It calls
 * roomie_msgs__srv__ControlLock_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_roomie_msgs
...
/**
 * It calls
 * roomie_msgs__srv__ControlLock_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * roomie_msgs__srv__ControlLock_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_roomie_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * roomie_msgs__srv__ControlLock_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_roomie_msgs
...
/**
 * It calls
 * roomie_msgs__srv__ControlLock_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_roomie_msgs
...
/**
 * It allocates the memory for the array and calls
 * roomie_msgs__srv__ControlLock_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_roomie_msgs
...
/**
 * It calls
 * roomie_msgs__srv__ControlLock_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROOMIE_MSGS__SRV__DETAIL__CONTROL_LOCK__FUNCTIONS_H_
